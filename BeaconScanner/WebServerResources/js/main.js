...
(function($) {
    ...
    $(document).ready(function() {
        $("table.sortable").each(function() {
            ...
            $('[data-role="tablefilter"]').each(function() {
                var search = $(this);
                search.quicksearch($('#' + search.attr('data-tableid')).find('tbody tr'), {
                    delay: 500
                })
            });
            console.log(table.prevAll('[type="search"]'));
        });
    });
})(jQuery);
